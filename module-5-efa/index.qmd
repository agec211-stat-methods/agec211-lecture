...
## working directory
setwd("C:/Users/chris/Documents/Github-repository/agec211-2024/agec211-lecture/module-5-efa")
...
- a linear regression with one independent variable (explanatory variable), and one dependent variable (response variable).
...
```{r}
knitr::include_graphics("plot/agec211-hex-logo.png")
```
